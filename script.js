...
const apiKey = '4cac7f20db63847ad1bd2c6cb782ba77'
...
async function updateWeatherInfo(city){
    const weatherData = await getFetchData('Weather', city)
        ...
        currentDateTxt.textContent = getCurrentDate(console.log(currentDateTxt))
...
function updateForecastItem(weatherData){
    ...
    const forecastsItem = `
        <div class="forcasts-item">
            <h5 class="forecast-item-data">${dataResult}</h5>
            <img src="images/${getweatherIcon(id)}" class="forcast-item-img">
            <h5 class="forecast-item-temp">${Math.round(temp)} °C</h5>
        </div>
    `
    forecastsItemContainer.insertAdjacentHTML('beforeend', forecastsItem)
}
